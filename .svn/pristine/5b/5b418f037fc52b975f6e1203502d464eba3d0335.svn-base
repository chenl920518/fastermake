		      ...
		      if(result.state == 0){
		    	  ...
		    	  for(var i=0;i<tl;i++){
		    		 ...
		    		 if(inquiryOrders[i].quoteState == null || inquiryOrders[i].quoteState == '' || inquiryOrders[i].quoteState == undefined){
		    			a = '<a href="/zh/detail.html?orderId='+inquiryOrders[i].orderId+'" class="amt10" title="'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'" target="_blank">'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'</a>'; 
		    		 }else{
