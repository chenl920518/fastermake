			    	  ...
			    	  for(var i=0;i<tl;i++){
			    		...
			    		//获取国家对标国旗
			    		  ...
			    		  var tr =   '<tr>'+
					                      ...
					                      '<a href="/en/detail.html?orderId='+inquiryOrders[i].orderId+'" class="amt10" title="'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'" target="_blank">'+(inquiryOrders[i].quoteTitle == null ? inquiryOrders[i].productName : inquiryOrders[i].quoteTitle)+'</a>'+
					                  '</td>'+
					                  '<td class="d2">'+
		    		  ...
		    		  if(injectionOrders != null && injectionOrders != '' && injectionOrders != undefined){
		    			  ...
		    			  for(var i=0;i<injectionOrders.length;i++){
		    				  ...
		    				  var tr = '<tr>'+
			        						...
			        						'</div>'+
			        						'<a href="/en/detail.html?orderId='+injectionOrders[i].orderId+'" class="amt10" title="'+(injectionOrders[i].quoteTitle == null ? injectionOrders[i].productName : injectionOrders[i].quoteTitle)+'" target="_blank">'+(injectionOrders[i].quoteTitle == null ? injectionOrders[i].productName : injectionOrders[i].quoteTitle)+'</a>'+
			        					'</td>'+
...
//			        					'<td><a href="/en/detail.html?orderId='+injectionOrders[i].orderId+'" class="bj">Quotation</a></td>'+
			        				'</tr>';		
		    		  ...
		    		  if(metalOrders != null && metalOrders != '' && metalOrders != undefined){
		    			  ...
		    			  for(var i=0;i<metalOrders.length;i++){
		    				  ...
		    				  var tr = '<tr>'+
			        						...
			        						'</div>'+
			        						'<a href="/en/detail.html?orderId='+metalOrders[i].orderId+'" class="amt10" title="'+(metalOrders[i].quoteTitle == null ? metalOrders[i].productName : metalOrders[i].quoteTitle)+'" target="_blank">'+(metalOrders[i].quoteTitle == null ? metalOrders[i].productName : metalOrders[i].quoteTitle)+'</a>'+
			        					'</td>'+
		    		  ...
		    		  if(machiningOrders != null && machiningOrders != '' && machiningOrders != undefined){
		    			  ...
		    			  for(var i=0;i<machiningOrders.length;i++){
		    				  ...
		    				  var tr = '<tr>'+
			        						...
			        						'</div>'+
			        						'<a href="/en/detail.html?orderId='+machiningOrders[i].orderId+'" class="amt10" title="'+(machiningOrders[i].quoteTitle == null ? machiningOrders[i].productName : machiningOrders[i].quoteTitle)+'" target="_blank">'+(machiningOrders[i].quoteTitle == null ? machiningOrders[i].productName : machiningOrders[i].quoteTitle)+'</a>'+
			        					'</td>'+
		    		  ...
		    		  if(castingOrders != null && castingOrders != '' && castingOrders != undefined){
		    			  ...
		    			  for(var i=0;i<castingOrders.length;i++){
		    				  ...
		    				  var tr = '<tr>'+
			        						...
			        						'</div>'+
			        						'<a href="/en/detail.html?orderId='+castingOrders[i].orderId+'" class="amt10" title="'+(castingOrders[i].quoteTitle == null ? castingOrders[i].productName : castingOrders[i].quoteTitle)+'" target="_blank">'+(castingOrders[i].quoteTitle == null ? castingOrders[i].productName : castingOrders[i].quoteTitle)+'</a>'+
			        					'</td>'+
...
//								        					'<th class="th3"></th>'+
		    		  ...
		    		  if(otherOrders != null && otherOrders != '' && otherOrders != undefined){
		    			  ...
		    			  for(var i=0;i<otherOrders.length;i++){
		    				  ...
		    				  '</div>'+
		    				  '<a href="/en/detail.html?orderId='+otherOrders[i].orderId+'" class="amt10" title="'+(otherOrders[i].quoteTitle == null ? otherOrders[i].productName : otherOrders[i].quoteTitle)+'" target="_blank">'+(otherOrders[i].quoteTitle == null ? otherOrders[i].productName : otherOrders[i].quoteTitle)+'</a>'+
		    				  '</td>'+
