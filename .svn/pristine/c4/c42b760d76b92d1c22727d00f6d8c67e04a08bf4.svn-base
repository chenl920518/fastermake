		    		...
		    		if(strs.length != 0){
			  	   ...
			  	   //判断当前报价数(没有则不显示)
					   ...
					   for(var k=0;k<supplierQuoteInfos.length;k++){				   
						...
						var tr=   ' <tr>'+
				                        '<td>'+
				                        '<h6><a href="/zh/view_factory_info.html?id='+supplierQuoteInfos[k].factoryId+'" target="_blank" class="w110 h_over">'+(supplierQuoteInfos[k].factoryName == null ? '' : supplierQuoteInfos[k].factoryName)+'</a></h6>'+
